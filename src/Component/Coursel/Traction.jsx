const Traction = () => {
    return (
        <>
            <div className="my-8">
                <h1 className="text-3xl font-bold text-primary-600 mb-6">Traction</h1>
                <hr style={{ width: '56px' }} className="mb-6 text-primary-800" />
            </div>
            <div className="text-center">
                <h1 className="text-5xl font-bold"><span className="text-primary-600">$2M </span>2022 EU revenue</h1>
                <h1 className="text-5xl font-bold"><span className="text-primary-600">15k+</span> users</h1>
            </div>
            <div>
            ...
            <div className="mb-10">
                <h2 className="text-primary-600 text-3xl text-center font-bold my-10">Key Statistics</h2>
                <div>
