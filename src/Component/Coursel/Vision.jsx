const VisionAndStrategy = () => {
    return (
        <>
            <div className="my-24"></div>
            <div className="my-8">
                <h1 className="text-3xl font-bold text-gray-600 mb-6">Vision and strategy
                </h1>
            ...
            <div className="justify-center flex flex-col text-center my-10 text-2xl font-bold text-gray-600">
                <hr className="my-6 text-gray-800" />
                Vision
                <hr className="my-6 text-gray-800" />
            </div>
            <div className="text-start text-xl text-gray-800 my-8">
