const Busness = () => {
    return (
        <>
            ...
            <div className="my-8">
                <h1 className="text-3xl font-bold text-primary-600 mb-6">Business model
                </h1>
            ...
            <div className="justify-center flex flex-col text-start my-10 text-xl">
                ...
                <br />
                <strong className="mt-10 text-primary-600">SaaS Subscription Model</strong>
                ...
                <br />
                <strong className="mt-10 text-primary-600">B2B Collaborations
                </strong>
