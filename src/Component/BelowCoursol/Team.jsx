                        ...
                        {team_members.map((data, index) => (
                            <div key={index} class="max-w-sm bg-white ">
                                ...
                                <div class="p-2 text-center ">
                                    <h2 class="mb-2 text-4xl  tracking-tight text-primary-900">{data.h2}</h2>
                                    <h4 class="mb-5 text-2xl  tracking-tight text-primary-600">{data.h4}</h4>
                                    <p class="mb-3 font-normal text-primary-900">{data.p}</p>
                                </div>
                            </div>
                        ))}
                    </div>
