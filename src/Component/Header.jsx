    ...
    return (
        <>
            ...
            <div className="container mx-auto">
                <nav className="border-primary-200 px-2 mb-10">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:flex md:items-center md:ml-6" id="mobile-menu">
                                <div className="relative">
                                    ...
                                    <input type="text" id="email-adress-icon" className="bg-primary-50 border border-primary-300 text-primary-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2" placeholder="Search..." />
                                </div>
                                <div className="md:ml-4">
                                    <ul className="flex space-x-8">
                                        <li>
                                            <a href="/" className="text-primary-700 hover:bg-primary-50 border-b border-primary-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Investor</a>
                                        </li>
                                        <li>
                                            <a href="/" className="text-primary-700 hover:bg-primary-50 border-b border-primary-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Businesses</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
